 ...
 * TODO
 */
public class DragAndDropUtility extends MouseAdapter
{
    ...
    private void startDragging(JComponent parent, Point pt)
    {
        ...
        window.setSize(draggingComonent.getSize());
    ...
    // TODO added on button click...
    public void startDragAndDropReorder(JComponent draggingComonent)
    {
        //MouseInfo.getPointerInfo().getLocation();
        this.draggingComonent = draggingComonent;
        startPt = draggingComonent.getLocation();
    }
    ...
    private JComponent makeUI()
    {
        ...
        final DragAndDropUtility dh = new DragAndDropUtility();
    ...
    public static void main(String... args)
    {
        ...
        f.getContentPane().add(new DragAndDropUtility().makeUI());
        f.setSize(320, 240);
